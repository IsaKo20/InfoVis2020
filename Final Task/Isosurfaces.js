function Isosurfaces( volume, isovalue, cmap_choice, reflection_choice, camera, light)
{
    var geometry = new THREE.Geometry();
    //var material = new THREE.MeshLambertMaterial();

    // Choose Color map type
    console.log(cmap_choice)
    if(cmap_choice == 0){
    var cmap = [];
    for ( var i = 0; i < 256; i++ )
    {
    ...
    // Choose reflection_model type
    console.log(reflection_choice)
    if(reflection_choice==0){
      var reflection_model = "Lambert";
    }else if(reflection_choice==1){
